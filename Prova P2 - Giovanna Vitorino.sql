...
CREATE DATABASE LOJAMARIACJ3028607;
GO


-- Habilita o contexto do banco de dados
USE LOJAMARIACJ3028607;
GO
...
SELECT	MAX(ValorUnitario) AS 'Produto mais caro',
		MIN(ValorUnitario) AS 'Produto mais barato'
FROM PRODUTOS;
GO
...
SELECT	CodigoVendedor	AS 'ID do vendedor',
...
SELECT	NumeroPedido				AS 'Número do pedido',
		COUNT(CodigoProduto)		AS 'Qtde. de produtos distintos',
...
SELECT	CodigoVendedor	AS 'Código',
		NomeVendedor	AS 'Nome',
		Salario			AS 'Salario',
...
JOIN ITEM_DE_PEDIDO IP	ON PE.NumeroPedido 	 = IP.NumeroPedido
...
DROP DATABASE LOJAMARIACJ3028607;
GO
